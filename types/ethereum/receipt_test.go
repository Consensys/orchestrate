...
func TestLog(t *testing.T) {
	...
	assert.Equal(t, "0x3b198bfd5d2907285af009e9ae84a0ecd63677110d89d7e030251acb87f6487e", log.GetTxHash().Hex(), "TxHash should match")
...
func TestReceipt(t *testing.T) {
	...
	assert.Equal(t, "0xAf84242d70aE9D268E2bE3616ED497BA28A7b62C", r.GetContractAddress().Address().Hex(), "ContractAddress should match")
	...
	assert.Equal(t, "0x3b198bfd5d2907285af009e9ae84a0ecd63677110d89d7e030251acb87f6487e", r.GetTxHash().Hex(), "TxHash should match")
	...
	assert.Equal(t, "0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef", r.GetBlockHash().Hex(), "BlockHash should match")
