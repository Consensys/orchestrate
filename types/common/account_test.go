...
func TestAccountInstance(t *testing.T) {
	i := &AccountInstance{
		Chain:   &Chain{Id: "1"},
		Account: &Account{Addr: "0xAf84242d70aE9D268E2bE3616ED497BA28A7b62C"},
	}
	short, err := i.Short()
	assert.NoError(t, err, "Short should not error")
	assert.Equal(t, "0xAf84242d70aE9D268E2bE3616ED497BA28A7b62C@1", short, "Short should be correct")

	i = &AccountInstance{
		Chain:   &Chain{Id: "1"},
		Account: &Account{Addr: "0xAf8424E2bE3616ED497BA28A7b62C"},
	}
	short, err = i.Short()
	assert.Error(t, err, "Short on wrong address should error")
	assert.Equal(t, "", short, "Short should not be correct")
}
