...
func (m *MockSecretStore) Store(ctx context.Context, key, value string) error {
	m.ctrl.T.Helper()
...
func (mr *MockSecretStoreMockRecorder) Store(ctx, key, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockSecretStore)(nil).Store), ctx, key, value)
}

// Load mocks base method
func (m *MockSecretStore) Load(ctx context.Context, key string) (string, bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSecretStoreMockRecorder) Load(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Load", reflect.TypeOf((*MockSecretStore)(nil).Load), ctx, key)
}
...
func (mr *MockSecretStoreMockRecorder) Delete(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockSecretStore)(nil).Delete), ctx, key)
}
