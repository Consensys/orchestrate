...
func (s *Server) createTCPRouters(ctx context.Context, configuration *runtime.Configuration, entryPoints []string, handlers, handlersTLS map[string]http.Handler) map[string]*tcpCore.Router {
...
func (s *Server) createHTTPHandlers(ctx context.Context, configuration *runtime.Configuration, entryPoints []string) (routerHandlers, handlersTLS map[string]http.Handler) {
