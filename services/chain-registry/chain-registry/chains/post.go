...
// @Failure 500
// @Router /chains [post]
func (h *Chains) PostChain(rw http.ResponseWriter, request *http.Request) {
...
func (h *Chains) newChain(ctx context.Context, request *PostRequest) (*types.Chain, error) {
...
func (h *Chains) processStartingBlock(ctx context.Context, fromBlock *string, urls []string) (uint64, error) {
