...
// @Failure 500
// @Router /faucets [get]
func (h *Faucets) GetFaucets(rw http.ResponseWriter, request *http.Request) {
...
func (h *Faucets) GetFaucet(rw http.ResponseWriter, request *http.Request) {
	rw.Header().Set("Content-Type", "application/json")
