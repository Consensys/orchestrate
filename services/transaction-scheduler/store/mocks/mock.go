...
func (m *MockJobAgent) Search(ctx context.Context, tenantID string, txHashes []string) ([]*models.Job, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", ctx, tenantID, txHashes)
	ret0, _ := ret[0].([]*models.Job)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockJobAgentMockRecorder) Search(ctx, tenantID, txHashes interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Search", reflect.TypeOf((*MockJobAgent)(nil).Search), ctx, tenantID, txHashes)
}
