...
// 	URL:      "test-url",
// 	ChainID:  "888",
// 	Listener: dynamic.Listener{ExternalTxEnabled: utils.ToPtr(false).(*bool)},
// }
// 
...
// 	cacheMngr := mocks2.NewMockManager(ctrl)
// 	cacheMngr.EXPECT().Get(gomock.Any(), gomock.Any()).AnyTimes().Return(nil, false)
// 	cacheMngr.EXPECT().Set(gomock.Any(), gomock.Any(), gomock.Any()).AnyTimes().Return(false)
// 
// 	// Initialize hook
// 	conf := &Config{
...
// 	}
// 
// 	contract := testutils.FakeContractResponse()
// 
...
// 		}
// 
// 		hk := NewHook(conf, ec, producer, client, cacheMngr)
// 
// 		var block ethtypes.Block
