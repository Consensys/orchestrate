...
func TestFetchBlock(t *testing.T) {
	...
	txScheduler.EXPECT().SearchJob(gomock.Any(), gomock.Any()).Return([]*types2.JobResponse{testutils.FakeJobResponse()}, nil)
...
func TestFetchBlockExternalTxDisabled(t *testing.T) {
	...
	txScheduler.EXPECT().SearchJob(gomock.Any(), gomock.Any()).Return([]*types2.JobResponse{}, nil)
