...
import (
	...
	store "gitlab.com/ConsenSys/client/fr/core-stack/orchestrate.git/services/envelope-store/store"
	reflect "reflect"
)
...
func (m *MockBuilder) Build(ctx context.Context, conf *store.Config) (proto.EnvelopeStoreServer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Build", ctx, conf)
	ret0, _ := ret[0].(proto.EnvelopeStoreServer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
