...
import (
	...
	json2 "gitlab.com/ConsenSys/client/fr/core-stack/orchestrate.git/v2/pkg/encoding/json"
	http2 "gitlab.com/ConsenSys/client/fr/core-stack/orchestrate.git/v2/pkg/http"
