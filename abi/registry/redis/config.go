...
var (
	...
	redisMaxIdleConnDesc = fmt.Sprintf(`Maximum number of idle connexion in the redis pool.
...
var (
	...
	redisMaxActiveConnDesc = fmt.Sprintf(`Maximum number of active connexion in the redis pool
...
var (
	...
	redisMaxConnLifetimeDesc = fmt.Sprintf(`Max lifetime of a redis connexion in the pool
