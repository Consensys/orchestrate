	...
	testSet := []struct {
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0x0d0b9391970d9a25552f37d436d2aae2925e2bfe1b2a923754bada030c498cb3"),
					ethereum.HexToHash("0x0000000000000000000000008dd688660ec0babd0b8a2f2de3232645f73cc5eb"),
					ethereum.HexToHash("0x000000000000000000000000e269e891a2ec8585a378882ffa531141205e92e9"),
					ethereum.HexToHash("0xf08499c9e419ea8c08c4b991f88632593fb36baf4124c62758acb21898711088"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xd8589d63a2df3a19b774d092cc22aec68d0be6537da4f37a362fbba9f6296845"),
				},
			},
			map[string]string{
				"index_origin": "1",
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xc69e2952deb9c87385c05617318dac13d6e25ebcf771aa2ae600cc8b1c1c7c73"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xfe5678ff8df37e23934e6875e6f96885f66eb0185376749e5e0c0e9a91d2f181"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xe93cecbaa9dac518aeb3ecb88fe5e11971da9ddc0d88eaa71902ca0ac9d6afdd"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0x4e9f8c6a9ba6c36d9f69bdaeda487b34fcba584137b513dd615a59ded56c939a"),
				},
			},
			map[string]string{
				"array": "[\"1\",\"11\",\"111\"]",
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0x39cc9b81f311e9bdf9c08720512a61f27e13fd23c9f03938c704e02a6145c45d"),
				},
			},
			map[string]string{
				"array": "[\"9\",\"99\",\"999\"]",
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0x85dfc0f9608903e59d1fc7374a0697adb9fcbc35e25888ede73ed16380ac6dbd"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xa18b22ca18dff5c2b530dcda530785cb179fd62c5b113971ca9014a86d716832"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xd5382ec33a47d9fd2a8bc6b79938a702d96b8d9caf99455323318181d9069162"),
				},
			},
			map[string]string{
		...
		},
		{
			...
			&ethereum.Log{
				...
				Topics: []*ethereum.Hash{
					ethereum.HexToHash("0xc270a86bd76188052175715b1997fa46780b24c6892bbd0f6ff98066f83543a4"),
				},
			},
			map[string]string{
				"t": "{\"A\":\"1\",\"B\":\"-1\"}",
