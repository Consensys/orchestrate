...
--plugin-kafka-producer-property=\"sasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required username=${PPLUS_KAFKA_USERNAME} password=${PPLUS_KAFKA_PASSWORD};\" \
