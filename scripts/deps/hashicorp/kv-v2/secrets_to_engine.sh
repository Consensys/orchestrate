...
## LIST 
#curl --header "X-Vault-Token: s.NgzcCBMPHQ2FFtxnENy6ap7S" \
#    --request LIST \
#    http://127.0.0.1:8200/v1/secret/metadata/default

# READ
#curl --header "X-Vault-Token: s.nTVRaFmwqYdWIMH14iUo1Jql" \
#    http://127.0.0.1:8200/v1/secret/data/default/_0x6009608A02a7A15fd6689D6DaD560C44E9ab61Ff
