...
PARAMETERS=""
[ "$TARGET_NAMESPACE" ] && export PARAMETERS=$PARAMETERS,\"target_namespace\":\"$TARGET_NAMESPACE\"
[ "$ORCHESTRATE_TAG" ] && export PARAMETERS=$PARAMETERS,\"orchestrate_tag\":\"$ORCHESTRATE_TAG\"
[ "$E2E_TAG" ] && export PARAMETERS=$PARAMETERS,\"e2e_tag\":\"$E2E_TAG\"
[ "$ORCHESTRATE_REPOSITORY" ] && export PARAMETERS=$PARAMETERS,\"orchestrate_repository\":\"$ORCHESTRATE_REPOSITORY\"
[ "$E2E_REPOSITORY" ] && export PARAMETERS=$PARAMETERS,\"e2e_repository\":\"$E2E_REPOSITORY\"
