...
// func ctxToProducerMessage(ctx *infra.Context) *sarama.ProducerMessage {
// 	ctx.Pb.Reset()
...
// func makeCreditMessage(chainID *big.Int, a common.Address, value *big.Int) *sarama.ProducerMessage {
// 	// Create a trace for
// 	t := types.NewTrace()
// 	*t.Chain().ID = *chainID
...
// 	h.w.Use(
// 		handlers.GasPricer(
// 			handlers.NewSimpleGasManager(newEthClient(chainURL)),
// 		),
// 	)
...
// 	// Faucet
// 	cfg := &handlers.SimpleCreditControllerConfig{
// 		BalanceAt: handlers.NewEthBalanceAt(newEthClient(chainURL)),
...
// 	}
// 	crediter  := handlers.NewSaramaCrediter(
// 		newSaramaSyncProducer(newSaramaClient(kafkaURL)),
// 		makeCreditMessage,
// 	)
// 	controller :=  handlers.NewSimpleCreditController(cfg, 50)
// 	h.w.Use(handlers.Faucet(crediter, controller))

// 	// Nonce
// 	h.w.Use(
// 		handlers.NonceHandler(
// 			handlers.NewCacheNonce(
// 				handlers.NewNonceEthClient(newEthClient(chainURL)),
// 				20,
// 			),
// 		),
// 	)
...
// 	// Signer
// 	txSigner := handlers.NewStaticSigner(
// 		[]string{
...
// 	h.w.Use(
// 		handlers.Sender(
// 			handlers.NewSimpleSender(newEthClient(chainURL)),
// 		),
// 	)
