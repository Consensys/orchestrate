...
Feature: Multiple transactions
  ...
  Scenario: Send raw transactions
    ...
    When I send envelopes to topic "tx.sender"
      ...
      | besu      | raw                  | 0xf86780808252089488a5c2d9919e46f883eb62f7b8dd9d0cc45bc2908806f05b59d3b20000801ca09fd94be4942219541b1fd100341706e2e4caa365c926cde48d8c7aac8c5a0f69a034a00bd00f4ef680a3586208c462280d99cb35e8a89479494af09a7228fdd46a |
    Then Envelopes should be in topic "tx.decoded"
