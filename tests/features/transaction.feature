...
Feature: Multiple transactions
  ...
  Scenario: Send transactions
    ...
    When I send envelopes to topic "tx.crafter"
      | chain.id           | from                                       | tx.to | method.sig                | args                                           | tenantid                             |
      | chain.primary      | 0x7E654d251Da770A068413677967F6d3Ea2FeA9E4 | token | transfer(address,uint256) | 0xdbb881a51cd4023e4400cef3ef73046743f08da3,0x1 | f30c452b-e5fb-4102-a45d-bc00a060bcc6 |
      | chain.primary      | 0x7E654d251Da770A068413677967F6d3Ea2FeA9E4 | token | transfer(address,uint256) | 0x6009608a02a7a15fd6689d6dad560c44e9ab61ff,0x2 | f30c452b-e5fb-4102-a45d-bc00a060bcc6 |
