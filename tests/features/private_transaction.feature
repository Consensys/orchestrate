...
Feature: Deploy private ERC20 contract
  ...
  Scenario: Batch deploy private ERC20 contract with Besu and Orion with different privateFrom
    ...
    When I send envelopes to topic "tx.crafter"
      | chainName | from                                       | contractName | methodSignature | privateFor                                   | privateFrom                                  | method                     | tenantid                             |
      | besu      | 0x93f7274c9059e601be4512f656b57b830e019e41 | SimpleToken  | constructor()   | k2zXEin4Ip/qBGlRkJejnGWdP9cjkK+DAvKNW31L2C8= | Ko2bVqD+nNlNYL5EE7y3IdOnviftjiizpjRt+HTuFBs= | EEA_SENDPRIVATETRANSACTION | f30c452b-e5fb-4102-a45d-bc00a060bcc6 |
      | besu_1    | 0xa8d8db1d8919665a18212374d623fc7c0dfda410 | SimpleToken  | constructor()   | k2zXEin4Ip/qBGlRkJejnGWdP9cjkK+DAvKNW31L2C8= | A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo= | EEA_SENDPRIVATETRANSACTION | f30c452b-e5fb-4102-a45d-bc00a060bcc6 |
      | besu      | 0x93f7274c9059e601be4512f656b57b830e019e41 | SimpleToken  | constructor()   | k2zXEin4Ip/qBGlRkJejnGWdP9cjkK+DAvKNW31L2C8= | Ko2bVqD+nNlNYL5EE7y3IdOnviftjiizpjRt+HTuFBs= | EEA_SENDPRIVATETRANSACTION | f30c452b-e5fb-4102-a45d-bc00a060bcc6 |
      | besu_1    | 0x93f7274c9059e601be4512f656b57b830e019e41 | SimpleToken  | constructor()   | k2zXEin4Ip/qBGlRkJejnGWdP9cjkK+DAvKNW31L2C8= | A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo= | EEA_SENDPRIVATETRANSACTION | f30c452b-e5fb-4102-a45d-bc00a060bcc6 |
    Then Envelopes should be in topic "tx.crafter"
    Then Envelopes should be in topic "tx.signer"
    Then Envelopes should be in topic "tx.sender"
    Then Envelopes should be in topic "tx.decoded"
