...
#    When I send envelopes to topic "tx.crafter"
#      | chainName | from                                       | contractName | methodSignature | privateFor                                   | privateFrom                                  | method                     | tenantid                             |
#      | besu      | 0x93f7274c9059e601be4512f656b57b830e019e41 | SimpleToken  | constructor()   | k2zXEin4Ip/qBGlRkJejnGWdP9cjkK+DAvKNW31L2C8= | Ko2bVqD+nNlNYL5EE7y3IdOnviftjiizpjRt+HTuFBs= | EEA_SENDPRIVATETRANSACTION | _ |
#      | besu_1    | 0xdbb881a51cd4023e4400cef3ef73046743f08da3 | SimpleToken  | constructor()   | k2zXEin4Ip/qBGlRkJejnGWdP9cjkK+DAvKNW31L2C8= | A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo= | EEA_SENDPRIVATETRANSACTION | _ |
#    Then Envelopes should be in topic "tx.crafter"
#    Then Envelopes should be in topic "tx.signer"
#    Then Envelopes should be in topic "tx.sender"
#    Then Envelopes should be in topic "tx.decoded"
