...
func (s *StoreServiceTestSuite) TestLoadByID() {
	...
	assert.Equal(s.T(), "0x0a0cafa26ca3f411e6629e9e02c53f23713b0033d7a72e534136104b5447a210", resp.GetEnvelope().GetTx().GetHash().Hex(), "Envelope should be correctly loaded")
}
