...
const DefaultDomain = "orchestrate.default.com"
...
func DefaultCertificate() (*tls.Certificate, error) {
	...
	domain := fmt.Sprintf("%s.%s.orchestrate.default", z[:32], z[32:])
...
func KeyPair(domain string, expiration time.Time) (cert, key []byte, err error) {
