...
func (m *MockEth1Client) SignEth1(ctx context.Context, storeName, address string, request *types.SignHexPayloadRequest) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SignEth1", ctx, storeName, address, request)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEth1ClientMockRecorder) SignEth1(ctx, storeName, address, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SignEth1", reflect.TypeOf((*MockEth1Client)(nil).SignEth1), ctx, storeName, address, request)
}
...
// SignEth1 mocks base method
func (m *MockKeyManagerClient) SignEth1(ctx context.Context, storeName, address string, request *types.SignHexPayloadRequest) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SignEth1", ctx, storeName, address, request)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// SignEth1 indicates an expected call of SignEth1
func (mr *MockKeyManagerClientMockRecorder) SignEth1(ctx, storeName, address, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SignEth1", reflect.TypeOf((*MockKeyManagerClient)(nil).SignEth1), ctx, storeName, address, request)
}
