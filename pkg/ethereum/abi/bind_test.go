...
func TestBindArg(t *testing.T) {
	testSet := []struct {
		...
		},
		{
			...
			func() interface{} { return ethcommon.HexToAddress("0xfF778b716FC07D98839f48DdB88D8bE583BEB684") },
			nil,
		},
		{
			"",
		...
		},
		{
			...
			func() interface{} {
				return []ethcommon.Address{
					ethcommon.HexToAddress("0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae"),
					ethcommon.HexToAddress("0x5ed8cee6b63b1c6afce3ad7c92f4fd7e1b8fad9f"),
					ethcommon.HexToAddress("0x9ee457023bb3de16d51a003a247baead7fce313d"),
				}
			},
			nil,
		},
