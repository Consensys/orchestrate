...
func TestMetrics(t *testing.T) {
	...
	reqsCounter.EXPECT().
		With("entrypoint", "entrypoint-test", "service", "service-test", "tenant_id", "_", "method", "GET", "protocol", "http", "code", "200").
		Return(reqsCounter)
	...
	openConnsGauge.EXPECT().
		With("entrypoint", "entrypoint-test", "service", "service-test", "tenant_id", "_", "method", "GET", "protocol", "http").
