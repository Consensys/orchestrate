...
import (
	configdynamic "github.com/containous/traefik/v2/pkg/config/dynamic"
)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Chains) DeepCopyInto(out *Chains) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Chains.
func (in *Chains) DeepCopy() *Chains {
	if in == nil {
		return nil
	}
	out := new(Chains)
