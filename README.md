...
Flags:
      --abi strings                Smart Contract ABIs to register for crafting (format (?P<contract_name>[a-zA-Z0-9]+):(?P<abi>\[.+\]))
      ...
      --faucet-address strings     Address of Faucet on each chain (format <chainID>:<Address>)
